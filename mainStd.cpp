...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/15 23:23:12 by tnguyen-          #+#    #+#             */
/*   Updated: 2023/02/15 23:55:30 by tnguyen-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::vector<int>::const_iterator	CIt = vecInt.begin();	
...

	{
		...
		std::vector<int>::iterator	It1 = vecInt.begin() + 3;
		std::vector<int>::iterator	It2 = It1 + 5;
	...
	std::vector<int>		baguette(vecInt);
	...
	{
		std::vector<int>::iterator	Iter = vecInt.end();
